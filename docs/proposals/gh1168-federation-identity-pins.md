...
base: 4de29306531c906f9a6701f9e8240ea5c8b8d36c
...
- `config/manager.go:309` — `	hasConfig, err := cm.establishPlatformIdentity(ctx, kvStore)`
- `config/manager.go:1327` — `		current.Services = make(types.ServiceConfigs)`
