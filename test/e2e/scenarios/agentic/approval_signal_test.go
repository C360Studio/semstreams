...
func TestValidateResultsRequiresBothWalks(t *testing.T) {
	complete := func() map[string]any {
		return map[string]any{
			...
			"approval_restart_created_sequence":     uint64(21),
			"approval_restart_created_ack_floor":    uint64(21),
			"approval_restart_created_pending":      0,
			"approval_restart_created_queued":       uint64(0),
			"approval_restart_pending_sequence":     uint64(22),
			"approval_restart_pending_ack_floor":    uint64(22),
			"approval_restart_pending_pending":      0,
			"approval_restart_pending_queued":       uint64(0),
