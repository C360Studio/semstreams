...
migration from 395 raw subject rows, 243 summed per-configuration exact keys, and 54 global strings to 571 effective
rows, 378 keys, and 69 strings.
...
- **THEN** the raw and effective totals equal 395/243/54 and 571/378/69 respectively
