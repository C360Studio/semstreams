...
#### Scenario: Selected-layout adoption starts on newly provisioned storage
...
#### Scenario: Fresh startup holds readiness until the watermark
...
#### Scenario: Contrary retained state does not create a migration path
