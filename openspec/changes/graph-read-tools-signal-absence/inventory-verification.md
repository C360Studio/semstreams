...
Design base `main@797d294a`. **Status: two independent review rounds (PR #1262 comments, 2026-09-05) both returned INVENTORY CHANGES REQUESTED; round 1's six findings are confirmed closed by the re-review; the round-2 table below closes round 2's; a third review and the owner's INVENTORY PASS are owed.** The
