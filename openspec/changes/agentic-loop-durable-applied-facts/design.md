...
| **OQ2** no approval-deadline hydration; the sentence becomes a spec scenario and a migration line | Scenario written; the migration line and its measured-delta test are **task 5.3, not yet landed** — § 5 is the next checkpoint | scenario `specs/agentic-loop/spec.md:58`; `tasks.md` 5.3 (open) |
