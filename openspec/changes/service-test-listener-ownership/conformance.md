...
| TLS wraps exactly once; request contexts descend from caller Start | `metric/handler_test.go:114` checks exact BaseContext; `:249` performs a real HTTPS request with the generated test CA. |
