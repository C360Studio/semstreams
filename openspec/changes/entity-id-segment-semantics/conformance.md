...
`task e2e:structural` pins `hierarchy_container_count:46` on local entities in the same run. Recorded for the
architect as the one remaining unobservable omission.
