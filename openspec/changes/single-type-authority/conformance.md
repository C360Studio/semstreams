...
| D3b | Readers, codec, and boot sweep never consult the registry (d3) | | `specs/graph-state-contract/spec.md` ADDED "The canonical codec and the boot sweep never consult the payload registry" | `TestResidentUnregisteredStampIsNotPoison` |
