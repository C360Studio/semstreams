...
**Status:** OWNER-ACCEPTED / DESIGN PASS — inactive implementation change.
**Repository baseline:** `ee3b43ce67f3ee6b39547317529da7ce1a783233`.
**Accepted inventory:** 595 lines, 36,227 bytes, SHA-256
`58e44190937c247a30ae5ce55621da27cddd113da6da858d64a2e9bc51bdd7fb`; companion verdict `INVENTORY PASS`.
**Accepted design:** 1,035 lines, 73,672 bytes, SHA-256
`be8e4c2c6fbcfbcd966038448011cf98112e62e52147b088a0a794808ec9b814`; companion verdict `DESIGN PASS`.

This artifact embeds the accepted inventory and owner-accepted design verbatim. They remain the sole design authority.
The wrapper adds no ruling and does not reinterpret either artifact.

## Part I — Accepted inventory (verbatim)
...
## Part II — Owner-accepted design (verbatim)
...
The exact inactive implementation order, all-unchecked task truth, and independent review checkpoints live in
[tasks.md](./tasks.md). Slices A–E translate the accepted design; they do not amend it.
