...
func (c *Component) createHandler(msgType MessageType, outputPortName string) func(context.Context, []byte) (natsclient.DeliveryDecision, error) {
...
func (c *Component) handleMessage(ctx context.Context, data []byte, msgType MessageType, outputPortName string) (natsclient.DeliveryDecision, error) {
	...
	if c.natsClient != nil {
		...
		if resolveErr != nil {
			atomic.AddInt64(&c.errors, 1)
			return natsclient.DeliveryDecisionQuarantine, fmt.Errorf("resolve validated output subject: %w", resolveErr)
		}
...
func (c *Component) setupConsumer(ctx context.Context, port component.Port, handler func(context.Context, []byte) (natsclient.DeliveryDecision, error)) error {
...
// drop: the call site returns early on refusal.
