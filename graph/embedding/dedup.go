...
// ContentHash generates a SHA-256 hash of text content for use as a
// content-addressed key.
//
// This function provides consistent hashing across the codebase for
// content-addressed storage.
//
// It keys on text ALONE, so it is only correct for state whose lifetime is
// scoped to a single embedder instance. It must NOT be used for the durable
// EMBEDDING_DEDUP bucket, which outlives any one embedder configuration —
// use DedupKey for that (gh#612).
